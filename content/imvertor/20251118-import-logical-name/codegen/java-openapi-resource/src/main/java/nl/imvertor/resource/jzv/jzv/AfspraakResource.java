...
@Path("/v1/afspraak")
@Tag(name = "Afspraak", description = "Een toezegging van een ketenpartner bepaalde handelingen of interventies zo snel mogelijk uit te gaan voeren.")
public class AfspraakResource {

  @GET
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "haalAlleAfspraakOp", summary = "Retourneert de lijst van alle Afspraak objecten", description = "Retourneert een gepagineerde lijst van alle Afspraak objecten")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.GepagineerdAfspraakLijst.class)),
  ...
  public Response haalAlleAfspraakOp(
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "maakAfspraakAan", summary = "Maakt een nieuw Afspraak object", description = "Maakt een nieuw Afspraak object aan op basis van de aangeleverde gegevens")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "201", description = "Afspraak succesvol aangemaakt",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Afspraak.class)),
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        @Header(name = "Warning", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Warning"),
        @Header(name = "X-Pagination-Page", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/X-Pagination-Page"),
        @Header(name = "X-Pagination-Limit", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/X-Pagination-Limit"),
  ...
  public Response maakAfspraakAan(
    @Parameter(description = "De gegevens van het Afspraak object", required = true) nl.imvertor.model.jzv.jzv.Afspraak afspraak) {
    return Response.ok().build();
  }

  @DELETE
  @Path("/{id}")
  @Operation(operationId = "verwijderAfspraak", summary = "Verwijderd een Afspraak object", description = "Verwijderd een specifiek Afspraak object permanent uit het systeem")
  @ApiResponses(value = {
  ...
  public Response verwijderAfspraak(
    @PathParam("id") @Parameter(description = "Afspraak ID", required = true, example = "123") String id) {
    return Response.ok().build();
  }
  ...
  @Path("/{id}")
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "haalAfspraakOp", summary = "Retourneert een Afspraak object op basis van zijn unieke identificatie", description = "Retourneert een individueel Afspraak object op basis van zijn unieke identificatie")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Afspraak.class)),
  ...
  public Response haalAfspraakOp(
    @PathParam("id") @Parameter(description = "Afspraak ID", required = true, example = "123") String id) {
    return Response.ok().build();
  }
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "werkAfspraakBij", summary = "Maakt nieuw of overschrijft bestaand Afspraak object", description = "Maakt een nieuw of overschrijft (volledig) een bestaand Afspraak object")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Afspraak.class)),
    ...
    @ApiResponse(responseCode = "201", description = "Afspraak succesvol aangemaakt",
      ...
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        ...
        @Header(name = "RateLimit-Reset", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/RateLimit-Reset"),
        @Header(name = "Location", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Location")}),
    @ApiResponse(responseCode = "204", description = "Afspraak succesvol geupdate",
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        @Header(name = "Location", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Location")}),
    @ApiResponse(responseCode = "400", ref="https://armatiek.github.io/imvertor-openapi-generator/openapi/common-responses.yaml#/components/responses/400"),
    @ApiResponse(responseCode = "401", ref="https://armatiek.github.io/imvertor-openapi-generator/openapi/common-responses.yaml#/components/responses/401"),
  ...
  public Response werkAfspraakBij(
    @PathParam("id") @Parameter(description = "Afspraak ID", required = true, example = "123") String id,
    @Parameter(description = "De gegevens van het Afspraak object", required = true) nl.imvertor.model.jzv.jzv.Afspraak afspraak) {
    return Response.ok().build();
  }
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "pasAfspraakAan", summary = "Werkt een bestaand Afspraak object gedeeltelijk bij", description = "Werkt een bestaand Afspraak object gedeeltelijk bij door alleen de aangeleverde velden te overschrijven")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Afspraak.class)),
  ...
  public Response pasAfspraakAan(
    @PathParam("id") @Parameter(description = "Afspraak ID", required = true, example = "123") String id,
    @Parameter(description = "De gegevens van het Afspraak object", required = true) nl.imvertor.model.jzv.jzv.Afspraak afspraak) {
    return Response.ok().build();
  }
