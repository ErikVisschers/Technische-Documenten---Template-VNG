...
@Path("/v1/betrokkene")
@Tag(name = "Betrokkene", description = "Een persoon die onderwerp is van de casus.")
public class BetrokkeneResource {

  @GET
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "haalAlleBetrokkeneOp", summary = "Retourneert de lijst van alle Betrokkene objecten", description = "Retourneert een gepagineerde lijst van alle Betrokkene objecten")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.GepagineerdBetrokkeneLijst.class)),
  ...
  public Response haalAlleBetrokkeneOp(
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "maakBetrokkeneAan", summary = "Maakt een nieuw Betrokkene object", description = "Maakt een nieuw Betrokkene object aan op basis van de aangeleverde gegevens")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "201", description = "Betrokkene succesvol aangemaakt",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Betrokkene.class)),
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        @Header(name = "Warning", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Warning"),
        @Header(name = "X-Pagination-Page", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/X-Pagination-Page"),
        @Header(name = "X-Pagination-Limit", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/X-Pagination-Limit"),
  ...
  public Response maakBetrokkeneAan(
    @Parameter(description = "De gegevens van het Betrokkene object", required = true) nl.imvertor.model.jzv.jzv.Betrokkene betrokkene) {
    return Response.ok().build();
  }

  @DELETE
  @Path("/{burgerservicenummer}")
  @Operation(operationId = "verwijderBetrokkene", summary = "Verwijderd een Betrokkene object", description = "Verwijderd een specifiek Betrokkene object permanent uit het systeem")
  @ApiResponses(value = {
  ...
  public Response verwijderBetrokkene(
    @PathParam("burgerservicenummer") @Parameter(description = "Betrokkene ID", required = true, example = "123") String burgerservicenummer) {
    return Response.ok().build();
  }
  ...
  @Path("/{burgerservicenummer}")
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "haalBetrokkeneOp", summary = "Retourneert een Betrokkene object op basis van zijn unieke identificatie", description = "Retourneert een individueel Betrokkene object op basis van zijn unieke identificatie")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Betrokkene.class)),
  ...
  public Response haalBetrokkeneOp(
    @PathParam("burgerservicenummer") @Parameter(description = "Betrokkene ID", required = true, example = "123") String burgerservicenummer) {
    return Response.ok().build();
  }
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "werkBetrokkeneBij", summary = "Maakt nieuw of overschrijft bestaand Betrokkene object", description = "Maakt een nieuw of overschrijft (volledig) een bestaand Betrokkene object")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Betrokkene.class)),
    ...
    @ApiResponse(responseCode = "201", description = "Betrokkene succesvol aangemaakt",
      ...
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        ...
        @Header(name = "RateLimit-Reset", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/RateLimit-Reset"),
        @Header(name = "Location", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Location")}),
    @ApiResponse(responseCode = "204", description = "Betrokkene succesvol geupdate",
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        @Header(name = "Location", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Location")}),
    @ApiResponse(responseCode = "400", ref="https://armatiek.github.io/imvertor-openapi-generator/openapi/common-responses.yaml#/components/responses/400"),
    @ApiResponse(responseCode = "401", ref="https://armatiek.github.io/imvertor-openapi-generator/openapi/common-responses.yaml#/components/responses/401"),
  ...
  public Response werkBetrokkeneBij(
    @PathParam("burgerservicenummer") @Parameter(description = "Betrokkene ID", required = true, example = "123") String burgerservicenummer,
    @Parameter(description = "De gegevens van het Betrokkene object", required = true) nl.imvertor.model.jzv.jzv.Betrokkene betrokkene) {
    return Response.ok().build();
  }
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "pasBetrokkeneAan", summary = "Werkt een bestaand Betrokkene object gedeeltelijk bij", description = "Werkt een bestaand Betrokkene object gedeeltelijk bij door alleen de aangeleverde velden te overschrijven")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Betrokkene.class)),
  ...
  public Response pasBetrokkeneAan(
    @PathParam("burgerservicenummer") @Parameter(description = "Betrokkene ID", required = true, example = "123") String burgerservicenummer,
    @Parameter(description = "De gegevens van het Betrokkene object", required = true) nl.imvertor.model.jzv.jzv.Betrokkene betrokkene) {
    return Response.ok().build();
  }
