...
@Path("/v1/scenario")
@Tag(name = "Scenario", description = "")
public class ScenarioResource {

  @GET
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "haalAlleScenarioOp", summary = "Retourneert de lijst van alle Scenario objecten", description = "Retourneert een gepagineerde lijst van alle Scenario objecten")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.GepagineerdScenarioLijst.class)),
  ...
  public Response haalAlleScenarioOp(
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "maakScenarioAan", summary = "Maakt een nieuw Scenario object", description = "Maakt een nieuw Scenario object aan op basis van de aangeleverde gegevens")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "201", description = "Scenario succesvol aangemaakt",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Scenario.class)),
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        @Header(name = "Warning", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Warning"),
        @Header(name = "X-Pagination-Page", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/X-Pagination-Page"),
        @Header(name = "X-Pagination-Limit", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/X-Pagination-Limit"),
  ...
  public Response maakScenarioAan(
    @Parameter(description = "De gegevens van het Scenario object", required = true) nl.imvertor.model.jzv.jzv.Scenario scenario) {
    return Response.ok().build();
  }

  @DELETE
  @Path("/{id}")
  @Operation(operationId = "verwijderScenario", summary = "Verwijderd een Scenario object", description = "Verwijderd een specifiek Scenario object permanent uit het systeem")
  @ApiResponses(value = {
  ...
  public Response verwijderScenario(
    @PathParam("id") @Parameter(description = "Scenario ID", required = true, example = "123") String id) {
    return Response.ok().build();
  }
  ...
  @Path("/{id}")
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "haalScenarioOp", summary = "Retourneert een Scenario object op basis van zijn unieke identificatie", description = "Retourneert een individueel Scenario object op basis van zijn unieke identificatie")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Scenario.class)),
  ...
  public Response haalScenarioOp(
    @PathParam("id") @Parameter(description = "Scenario ID", required = true, example = "123") String id) {
    return Response.ok().build();
  }
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "werkScenarioBij", summary = "Maakt nieuw of overschrijft bestaand Scenario object", description = "Maakt een nieuw of overschrijft (volledig) een bestaand Scenario object")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Scenario.class)),
    ...
    @ApiResponse(responseCode = "201", description = "Scenario succesvol aangemaakt",
      ...
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        ...
        @Header(name = "RateLimit-Reset", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/RateLimit-Reset"),
        @Header(name = "Location", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Location")}),
    @ApiResponse(responseCode = "204", description = "Scenario succesvol geupdate",
      headers = {@Header(name = "API-Version", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/API-Version"),
        @Header(name = "Location", ref = "https://armatiek.github.io/imvertor-openapi-generator/openapi/common-headers.yaml#/components/headers/Location")}),
    @ApiResponse(responseCode = "400", ref="https://armatiek.github.io/imvertor-openapi-generator/openapi/common-responses.yaml#/components/responses/400"),
    @ApiResponse(responseCode = "401", ref="https://armatiek.github.io/imvertor-openapi-generator/openapi/common-responses.yaml#/components/responses/401"),
  ...
  public Response werkScenarioBij(
    @PathParam("id") @Parameter(description = "Scenario ID", required = true, example = "123") String id,
    @Parameter(description = "De gegevens van het Scenario object", required = true) nl.imvertor.model.jzv.jzv.Scenario scenario) {
    return Response.ok().build();
  }
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(operationId = "pasScenarioAan", summary = "Werkt een bestaand Scenario object gedeeltelijk bij", description = "Werkt een bestaand Scenario object gedeeltelijk bij door alleen de aangeleverde velden te overschrijven")
  @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "OK",
      content = @Content(mediaType = "application/json",
      schema = @Schema(implementation = nl.imvertor.model.jzv.jzv.Scenario.class)),
  ...
  public Response pasScenarioAan(
    @PathParam("id") @Parameter(description = "Scenario ID", required = true, example = "123") String id,
    @Parameter(description = "De gegevens van het Scenario object", required = true) nl.imvertor.model.jzv.jzv.Scenario scenario) {
    return Response.ok().build();
  }
